...
# ===============================
    ...
    # ===============================
    # Build Combined Chart - SINGLE Y-AXIS
    # ===============================
    fig1 = make_subplots(
        rows=2, cols=1,
        ...
        row_heights=[0.5, 0.5],
        specs=[[{"secondary_y": False}], [{"secondary_y": False}]]  # Changed to False - single y-axis
    )
    
    # Daily Sales and Production (single y-axis)
    fig1.add_trace(
    ...
    # BTP Stock if available (same y-axis)
    ...
    # Cumulative Sales and Production (single y-axis)
    fig1.add_trace(
    ...
    # Cumulative Stock (same y-axis now)
    df_sc["Cumulative_Stock"] = df_sc["Stock"].cumsum()
    fig1.add_trace(
    ...
    # Update axes - SINGLE Y-AXIS FOR BOTH ROWS
    fig1.update_xaxes(title_text="Date", row=1, col=1)
    fig1.update_xaxes(title_text="Date", row=2, col=1)
    fig1.update_yaxes(title_text="Quantity", row=1, col=1)  # Single y-axis title
    fig1.update_yaxes(title_text="Cumulative Quantity", row=2, col=1)  # Single y-axis title
